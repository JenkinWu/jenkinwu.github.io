...
四、赶紧加入进来
作为一个有追求的程序员，你就应该爱自己，岂能被身体困扰？我希望你也加入这个计划来，告别亚健康！当然要是可以的话，我希望你在进行这个计划的同时配合 天天写代码计划 一起去完成，劳逸结合。

五、记录方法
签到表 >入口<
不想 fork ,你可以 Star ,在这个项目的 issue 管理健身计划 示例，你可以直接拿这个模板 issues-template 感谢 @akfish
任务领取/结对监督模式概念示例 初步方案，欢迎加入探讨。
六、目录
